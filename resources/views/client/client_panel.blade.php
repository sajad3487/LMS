        ...
        <div class="col-lg-6 col-xxl-4">
            ...
            <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                ...
                <div class="card-header border-0 bg-primary py-5">
                    <h3 class="card-title font-weight-bolder text-white">360 Degree Coaching Assessment of {{$user->name ?? ''}}</h3>
                    ...
                    <div class="card-spacer mt-n25">
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Behavior</h5>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col bg-light-success px-6 py-8 rounded-xl">
                                ...
                                <a href="#" class="text-success font-weight-bold font-size-h6 mt-2"  data-toggle="modal" data-target="#chat">
                                    Nour Chat
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <div class="text-center flex-grow-1">
                                                    <div class="text-dark-75 font-weight-bold font-size-h5">Nour Chat</div>
                                                    {{--                                                            <div>--}}
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="card-footer">
                                                    <form action="{{url("client/message/store")}}" method="post">
                                                    @csrf
                                                    ...
                                                    <!--begin::Compose-->
                                                        ...
                                                        <input type="number" name="destination_id" class="d-none" value="{{auth()->id()}}">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-4 col-md-10 col-sm-12">
                                                                            <select  name="user_id" class="form-control selectpicker" data-size="7" data-live-search="true">
                                                                                ...
                                                                                @foreach($users as $user_circle)
                                                                                    <option value="{{$user_circle->id}}">{{$user_circle->name ?? ''}} - {{$user_circle->email ?? ''}}</option>
                                                                                @endforeach
                                                                            </select>
