    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div
            ...
            <ul class="menu-nav ">
                ...
                <li class="menu-section ">
                    <h4 class="menu-text">Super Quiz</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                ...
                <li class="menu-item @if(isset($active) && $active == 5)menu-item-active @endif" aria-haspopup="true"><a href="{{url('super_result')}}" class="menu-link "><span
                        ...
                        </svg><!--end::Svg Icon--></span><span class="menu-text">Super Quiz Results</span></a>
                </li>
                ...
                <li class="menu-item @if(isset($active) && $active == 6)menu-item-active @endif" aria-haspopup="true"><a href="{{url('profile')}}" class="menu-link "><span
                            class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg--><svg
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
