...
<div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div
            ...
            <!--begin::Menu Nav-->
            <ul class="menu-nav ">
                <li class="menu-item @if(isset($active) && $active == 1)menu-item-active @endif " aria-haspopup="true"><a href="{{url('/home')}}"
                ...
                <li class="menu-item @if(isset($active) && $active == 2)menu-item-active @endif" aria-haspopup="true"><a href="{{url('/quizzes')}}" class="menu-link "><span
                        ...
                        </svg><!--end::Svg Icon--></span><span class="menu-text">Quizzes</span></a>
                </li>

                <li class="menu-item @if(isset($active) && $active == 3)menu-item-active @endif" aria-haspopup="true"><a href="{{url('result')}}" class="menu-link "><span
                            class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg--><svg
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <li class="menu-section ">
                    <h4 class="menu-text">Assessment</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>


                <li class="menu-item @if(isset($active) && $active == 4)menu-item-active @endif" aria-haspopup="true"><a href="{{url('/superQuizzes/')}}" class="menu-link "><span
                            class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg--><svg
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        </svg><!--end::Svg Icon--></span><span class="menu-text">Assessments</span></a>
                </li>
                ...
                <li class="menu-section ">
                    <h4 class="menu-text">Evaluation</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>


                <li class="menu-item @if(isset($active) && $active == 6)menu-item-active @endif" aria-haspopup="true"><a href="{{url('/evaluation/')}}" class="menu-link "><span
                            class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg--><svg
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
