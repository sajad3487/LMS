...
{{--                                        <a href="{{url("segments/$quiz->id/show")}}"><i class="flaticon-web  text-info mr-5"></i></a>--}}
                                        <a href="{{url("result/$quiz->id/answers")}}" class="btn btn-text-dark-50 btn-icon-success font-weight-bold btn-hover-bg-light p-1 py-2">
                                            <i class="flaticon2-pie-chart"></i> Answers
                                        </a>
